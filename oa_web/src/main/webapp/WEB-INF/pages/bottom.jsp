...
<script type="${pageContext.request.contextPath}/text/javascript" src="js/pages.js"></script>
<script type="${pageContext.request.contextPath}/text/javascript" src="js/items.js"></script>
</body>
</html>
