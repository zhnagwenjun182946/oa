    ...
    <aside id="sidebar_left" class="nano nano-light affix">
        <div class="sidebar-left-content nano-content">
            ...
            <ul class="nav sidebar-menu">
                ...
                <li>
                    <a class="accordion-toggle" href="${pageContext.request.contextPath}/employee/list">
                ...
                <li>
                    <a class="accordion-toggle" href="${pageContext.request.contextPath}/department/list">
